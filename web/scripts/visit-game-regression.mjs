...
assert(visitGameSource.includes("summary.hasEstimatedValue && summary.estimatedValueHigh >= 1000"), "Billion Euro Visitor must use aggregate-eligible reviewed estimates only");
...
assert(!visitGameSource.includes("MARKET_CONTEXT") || !visitGameSource.includes("estimatedValueHigh += numeric"), "Market context must not be summed as estimate");
